	...
	<div class="wrapper">
			...
			<nav id="navigation">
				...
				<ul class="stages">
					<li class="stage current-stage">
						<a href="#activities" class="nav-link button">Stages</a>
					</li>
					<li class="stage">
		...
		<section class="main-container">
			...
			<article id="activities" class="main-content">
				<header>
					<hgroup>
						<h1 class="main headline center">Choose the stages where you want to introduce usability improvements in your project</h1>
					</hgroup>
				</header>
...
$activities->load('../assets/xsl/stages.xsl');

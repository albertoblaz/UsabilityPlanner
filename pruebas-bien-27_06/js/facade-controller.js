	...
	UP.FacadeController = Backbone.Controller.extend({
		...
		setupEvents: function() {
			...
			this.actButtons.on('click', function() {
				...
				self.activitiesPanel.addClass( cssClass );
				self.activitiesPanel.eq(pos).removeClass( cssClass );

				self.actHeaders.addClass( cssClass );
				self.actHeaders.eq(pos).removeClass( cssClass );

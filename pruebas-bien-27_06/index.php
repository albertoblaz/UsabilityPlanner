<!DOCTYPE html>
<html lang="en" manifest="../assets/offline">
	...
	<div class="wrapper">
		...
		<section class="main-container">
			...
			<article id="activities" class="main-content">
				<header>
					<hgroup>
						<h1 class="act-header main headline center">Choose the activities where you want to introduce usability improvements in your project</h1>
						<h1 class="act-header main headline center hidden">At which activities of design and development would using UCD methods be most likely to improve usability?</h1>
					</hgroup>
				</header>
				

				<div class="act-buttons">
					<div class="act-button tab first"><p>Activities selection</p></div>
					<div class="act-button tab"><p>Prioritize activities</p></div>
				</div>
